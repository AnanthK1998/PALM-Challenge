...
model=build_model(pretrained_weights='weights/unetinceptionresnetv2_lr-5e-6_Jaccardloss_Adam.02-0.0417-0.9423.hdf5')
...
for img in tqdm(imgdir):
    ...
    pred=cv2.resize(result[0],(shape[1],shape[0]))*255
    
    cv2.imwrite('predicted/'+imgname+'.bmp',pred)
'''
